...
Route::get('threads/create', 'ThreadController@create')->name('threads.create')->middleware('must-be-confirmed')->name('threads.create');
...
Route::post('/threads/{channel}/{thread}/replies', 'ReplyController@store')->middleware('must-be-confirmed')->name('replies.store');
