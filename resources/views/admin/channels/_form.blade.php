...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="description" name="description" value="{{ old('description', $channel->description) }}"
        required>
</div>
...
<div class="form-group">
    ...
    <select name="archived" id="archived" class="form-control">
        ...
        <option value="1" {{ old('archived', $channel->archived) ? 'selected' : '' }}>Archievd</option>
    </select>
</div>
