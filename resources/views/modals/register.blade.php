    ...
    <modal name="register" height="auto">
        <form class="p-10" @submit.prevent="register">
            <div class="mb-6">
                ...
                <input type="text" class="w-full p-2 leading-normal" id="name" name="name" autocomplete="name" placeholder="John Doe" value="{{ old('name') }}"
                    required v-model="form.name" @keydown="errors.name = false">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="w-full p-2 leading-normal" id="username" name="username" autocomplete="username" placeholder="johndoe"
                    value="{{ old('username') }}" required v-model="form.username" @keydown="errors.username = false">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="w-full p-2 leading-normal" id="email" name="email" autocomplete="email" placeholder="joe@example.com"
                    value="{{ old('email') }}" required v-model="form.email" @keydown="errors.email = false">
            ...
            <div class="mb-6">
                ...
                <input type="password" class="w-full p-2 leading-normal" id="password" name="password" autocomplete="new-password" required
                    v-model="form.password" @keydown="errors.password = false">
            ...
            <div class="mb-6">
                ...
                <input type="password" class="w-full p-2 leading-normal" id="password_confirmation" name="password_confirmation" autocomplete="new-password"
                    required v-model="form.password_confirmation" @keydown="errors.password = false">
            </div>
