    ...
    <form method="POST" action="/threads" class="p-6 py-8">
        ...
        <div class="flex mb-6 -mx-4">
            ...
            <div class="flex-1 px-4">
                ...
                <select name="channel_id" id="channel_id" class="block appearance-none w-full bg-white rounded-none border border-grey-light text-grey-darker py-2 px-4 leading-normal pr-8"
                    required>
